<footer style="background-image: url({{ asset('user/assets/img/footer.png') }});background-color: #f5f8fd;">
    <div class="container">
        {{-- <div class="row">
            <div class="col-xl-4 col-lg-6">
                <div class="logo-white">
                    <a href="index.html"><img alt="logo-white" src="{{ asset('user/assets/img/logo-white.png') }}"></a>
        <p>Tuesday - Saturday: 12:00pm - 23:00pm
            <span>Closed on Sunday</span></p>
        <img alt="tripa" src="{{ asset('user/assets/img/tripa.png') }}">
    ...
    <div class="footer-bootem">
        <h6><span>© 2023</span> | Ala Cafe Jember.</h6>
        <div class="header-social-media">
            <a href="https://www.facebook.com/alacafe.jbr" target="_blank">Facebook</a>
            {{-- <a href="#">Twitter</a> --}}
            <a href="https://www.instagram.com/alacafe.jbr" target="_blank">Instagram</a>
            {{-- <a href="#">Youtube</a> --}}
        </div>
    </div>
    </div>
